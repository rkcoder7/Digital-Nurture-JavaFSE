INSERT INTO Customers VALUES (1,'John Doe',TO_DATE('1955-05-15','YYYY-MM-DD'),12000,SYSDATE,'FALSE');
INSERT INTO Customers VALUES (2,'Jane Smith',TO_DATE('1990-07-20','YYYY-MM-DD'),1500,SYSDATE,'FALSE');
INSERT INTO Customers VALUES (3,'Robert King',TO_DATE('1950-02-10','YYYY-MM-DD'),20000,SYSDATE,'FALSE');
...
INSERT INTO Loans VALUES (2,3,10000,7,SYSDATE,SYSDATE+25);
